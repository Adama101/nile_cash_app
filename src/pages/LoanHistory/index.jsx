        ...
        <table className="min-w-full bg-white border border-gray-300">
          ...
          <tbody>
            ...
            <td className="py-2 px-4 border-b">
              ...
              <td className="py-2 px-4 border-b">Obehi</td>
            ...
            <tr>
              ...
              <td className="py-2 px-4 border-b">Andrew</td>
              <td className="py-2 px-4 border-b">02/01/2024</td>
              <td className="py-2 px-4 border-b">02/25/2024</td>
              <td className="py-2 px-4 border-b">100</td>
              <td className="py-2 px-4 border-b">110</td>
            ...
            <tr>
              ...
              <td className="py-2 px-4 border-b">Peris</td>
              <td className="py-2 px-4 border-b">02/01/2024</td>
              <td className="py-2 px-4 border-b">02/25/2024</td>
              <td className="py-2 px-4 border-b">100</td>
              <td className="py-2 px-4 border-b">110</td>
            ...
            <tr>
              ...
              <td className="py-2 px-4 border-b">Emmanuel</td>
              <td className="py-2 px-4 border-b">02/01/2024</td>
              <td className="py-2 px-4 border-b">02/25/2024</td>
              <td className="py-2 px-4 border-b">100</td>
              <td className="py-2 px-4 border-b">110</td>
